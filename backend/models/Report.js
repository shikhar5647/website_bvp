...
const SanskarSchema = new mongoose.Schema({
  ...
  yuvaSanskar: {
    prev_shivir_duration: { type: Number, default: 0 },
    prev_activities: { type: Number, default: 0 },
    prev_presence: { type: Number, default: 0 },
    curr_shivir_duration: { type: Number, default: 0 },
...
const SewaSchema = new mongoose.Schema({
  ...
  bloodDonation: {
    prev_eye_sankalp: { type: Number, default: 0 },
    prev_eye_pairs: { type: Number, default: 0 },
    prev_blood_shivir: { type: Number, default: 0 },
    prev_blood_units: { type: Number, default: 0 },
    curr_eye_sankalp: { type: Number, default: 0 },
    curr_eye_pairs: { type: Number, default: 0 },
    curr_blood_shivir: { type: Number, default: 0 },
    curr_blood_units: { type: Number, default: 0 },
  },
  helpingNeedy: {
    prev_schools: { type: Number, default: 0 },
    prev_stationary_beneficiary: { type: Number, default: 0 },
    prev_blankets: { type: Number, default: 0 },
    prev_food: { type: Number, default: 0 },
    curr_schools: { type: Number, default: 0 },
    curr_stationary_beneficiary: { type: Number, default: 0 },
  ...
  divyangSahayta: {
    ...
    prev_artificial_limbs: { type: Number, default: 0 },
    prev_beneficiary: { type: Number, default: 0 },
    curr_shivir: { type: Number, default: 0 },
    curr_artificial_limbs: { type: Number, default: 0 },
    curr_beneficiary: { type: Number, default: 0 },
  },
  vanvasiSahayta: {
    prev_central: { type: Number, default: 0 },
    prev_local: { type: Number, default: 0 },
    curr_central: { type: Number, default: 0 },
    curr_local: { type: Number, default: 0 },
  },
  healthAwareness: {
    prev_yog_shivir: { type: Number, default: 0 },
    prev_yog_beneficiary: { type: Number, default: 0 },
    prev_nasha_programmes: { type: Number, default: 0 },
    prev_nasha_beneficiary: { type: Number, default: 0 },
    curr_yog_shivir: { type: Number, default: 0 },
    curr_yog_beneficiary: { type: Number, default: 0 },
    curr_nasha_programmes: { type: Number, default: 0 },
    curr_nasha_beneficiary: { type: Number, default: 0 },
  },
});
...
const MahilaSchema = new mongoose.Schema({
  ...
  familyAdoption: {
    ...
    prev_family_beneficiary: { type: Number, default: 0 },
    prev_family_amount: { type: Number, default: 0 },
    prev_girl_beneficiary: { type: Number, default: 0 },
    prev_girl_amount: { type: Number, default: 0 },
    curr_families: { type: Number, default: 0 },
    curr_family_beneficiary: { type: Number, default: 0 },
    curr_family_amount: { type: Number, default: 0 },
    curr_girl_beneficiary: { type: Number, default: 0 },
    curr_girl_amount: { type: Number, default: 0 },
  },
  atmnirbhar: {
    prev_sewing_centers: { type: Number, default: 0 },
    prev_sewing_beneficiary: { type: Number, default: 0 },
    prev_machines: { type: Number, default: 0 },
    prev_beauty_centers: { type: Number, default: 0 },
    prev_beauty_beneficiary: { type: Number, default: 0 },
    curr_sewing_centers: { type: Number, default: 0 },
    curr_sewing_beneficiary: { type: Number, default: 0 },
    curr_machines: { type: Number, default: 0 },
    curr_beauty_centers: { type: Number, default: 0 },
    curr_beauty_beneficiary: { type: Number, default: 0 },
  },
  abhiruchi: {
    prev_shivir: { type: Number, default: 0 },
    prev_activities: { type: Number, default: 0 },
    prev_beneficiary: { type: Number, default: 0 },
    prev_atm_activities: { type: Number, default: 0 },
    prev_atm_beneficiary: { type: Number, default: 0 },
    curr_shivir: { type: Number, default: 0 },
    curr_activities: { type: Number, default: 0 },
    curr_beneficiary: { type: Number, default: 0 },
    curr_atm_activities: { type: Number, default: 0 },
    curr_atm_beneficiary: { type: Number, default: 0 },
  },
});
...
const SamparkSchema = new mongoose.Schema({
  ...
  samuhikVivah: {
    prev_vivah: { type: Number, default: 0 },
    prev_pairs: { type: Number, default: 0 },
    curr_vivah: { type: Number, default: 0 },
    curr_pairs: { type: Number, default: 0 },
  },
  education: {
    prev_computer_centers: { type: Number, default: 0 },
    prev_computer_beneficiary: { type: Number, default: 0 },
    prev_library_centers: { type: Number, default: 0 },
    prev_library_beneficiary: { type: Number, default: 0 },
    curr_computer_centers: { type: Number, default: 0 },
    curr_computer_beneficiary: { type: Number, default: 0 },
    curr_library_centers: { type: Number, default: 0 },
    curr_library_beneficiary: { type: Number, default: 0 },
  },
  ekShakha: {
    prev_programmes: { type: Number, default: 0 },
    prev_beneficiaries: { type: Number, default: 0 },
    prev_amount: { type: Number, default: 0 },
    curr_programmes: { type: Number, default: 0 },
    curr_beneficiaries: { type: Number, default: 0 },
    curr_amount: { type: Number, default: 0 },
  },
});
...
const PermanentSewaSchema = new mongoose.Schema({
  ...
  prev_beneficiary: { type: Number, default: 0 },
  prev_cost: { type: Number, default: 0 },
  curr_projects: { type: Number, default: 0 },
  curr_beneficiary: { type: Number, default: 0 },
  curr_cost: { type: Number, default: 0 },
});
